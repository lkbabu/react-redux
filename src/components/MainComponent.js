...
const mapDispatchToProps = dispatch => ({
  ...
  postFeedback: (FisrtName,LastName,telNum,email,agree,contacyType,message)=>dispatch(postFeedback(FisrtName,LastName,telNum,email,agree,contacyType,message)),
